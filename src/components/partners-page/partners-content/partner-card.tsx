  ...
  return (
    <div className="overflow-hidden rounded-xl border border-bor-primary bg-primary">
      ...
      <div className="p-4 min-[768px]:p-5">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3 text-brand-secondary text-sm">
