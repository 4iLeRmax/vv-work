  ...
  return (
    <>
      <div className="w-95 shrink-0 flex flex-col items-center gap-8">
        <div className="w-full flex flex-col items-start bg-white rounded-xl border border-bor-primary p-8">
          ...
          <ul className="flex flex-col gap-3 mt-4">
            {perks.map((perk) => (
              <li key={perk} className="flex items-center gap-3">
                <div className="w-7 h-7 bg-brand-accent/10 text-brand-accent rounded-full flex items-center justify-center">
                  <Check size={20} />
                </div>
